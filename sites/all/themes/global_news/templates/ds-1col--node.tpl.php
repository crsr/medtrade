...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php if ($user_picture || !$page || $display_submitted): ?>
    <header class="submitted">
     ...
     &nbsp;| &nbsp;Written by <?php print render($name) ?> &nbsp;|&nbsp; <a href="<?php echo $node_url;?>#comments" class="comment_count"><?php echo $comment_count; ?></a>
    </header>
  <?php endif; ?>
  ...
  <?php if (!empty($content['related_articles'])): ?>
      <?php print render($content['related_articles']); ?>
  <?php endif; ?>
